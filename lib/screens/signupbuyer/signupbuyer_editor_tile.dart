import 'package:Love.Clothes/screens/welcome/welcome_buyer.dart';
...
class SignupBuyerEditorTile extends StatelessWidget {
  const SignupBuyerEditorTile(this.index);
